...
$statistik = query("SELECT * FROM cafe WHERE id = '1'");
...
if (isset($_POST["submit"])) {
   ...
   $rating = $_POST["rating"];
   $pesan = $_POST["pesan"];
   $result = mysqli_query($db, "INSERT INTO cafe1 (tanggal,rating,pesan,nama) VALUES ('$tanggal','$rating','$pesan', '$nama')");
   if ($result) {
      echo
      "
            <script>
                alert('Data Berhasil Ditambahkan!'); 
                document.location.href = 'userReview1.php' ;
            </script>
        ";
   } else {
      echo
