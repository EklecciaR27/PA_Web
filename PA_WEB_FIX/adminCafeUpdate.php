...
<head>
   ...
   <title>UPDATE CAFE</title>

   <!-- CONNECT -->
   <link rel="stylesheet" href="./assets/css/updateAdmin.css?v2">
      ...
      <main class="main-container">
         ...
         <div class="charts">
            <div class="main-title">
               <p class="font-weight-bold" style="text-align: center;">UPDATE DATA CAFE</p>
            </div>
            <div class="boxform">
               ...
               <form method="post" enctype="multipart/form-data">
                  ...
                  <!-- <div class="input-field button"> -->
                     <button>
                        <input class="update-field" type="submit" name="submit" value="Update">
                     </button>
                  <!-- </div> -->
