...
if (isset($_GET['search'])) {
   ...
   $query = mysqli_query($koneksi, "SELECT * FROM cafe3 where
   nama        LIKE '%$keyword%' OR
   pesan        LIKE '%$keyword%' OR
   rating        LIKE '%$keyword%'
   ");
} else {
   $query = mysqli_query($koneksi, "SELECT * FROM cafe3");
}
                  ...
                  <tbody>
                     ...
                     <?php foreach ($query as $data) : ?>
                        <tr>
                           ...
                           <td><a class="bi bi-trash" style="text-align: center; color: #6a9792; font-size: 25px" href="deleteReview3.php?id=<?php echo $data["id"]; ?> "></a></td>
                        </tr>
                        <?php $y++; ?>
                     <?php endforeach; ?>
                  </tbody>
