...
if (isset($_GET['search'])) {
   ...
   $query = mysqli_query($koneksi, "SELECT * FROM cafe1 where
   ...
   $query = mysqli_query($koneksi, "SELECT * FROM cafe1");
}
...
<body>
   <div class="grid-container">
      ...
      <main class="main-container">
         ...
         <?php
         require 'config.php';
         $result = $db->query("SELECT * FROM cafe1");
         ?>
         <!-- Isi -->
                  ...
                  <tbody>
                     ...
                     <?php foreach ($query as $data) : ?>
                        <tr>
                           ...
                           <td><a class="bi bi-trash" style="text-align: center; color: #6a9792; font-size: 25px" href="deleteReview1.php?id=<?php echo $data["id"]; ?> "></a></td>
                        </tr>
                        <?php $y++; ?>
                     <?php endforeach; ?>
                  </tbody>
