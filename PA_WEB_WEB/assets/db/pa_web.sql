...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2022 at 02:50 PM
...
('Satu Kata Coffee ', 54122332, 'Satu Kata Coffee merupakan salah satu cafe di Samarinda yang menyediakan aneka minuman kopi dan non kopi. Tempatnya cocok untuk kalian yang ingin hangout bareng keluarga, teman, maupun pacar.', 'Jl. Basuki Rahmat, Bugis, Kec. Samarinda Kota, Kota Samarinda, Kalimantan Timur 75242', 1, 'cafeSatuKata1.png'),
...
('balsjakhsk', 129912982, 'keren banget sug cafenya cy', 'Jalan jalan', 5, 'balsjakhsk.png');
...
(2, 2022, 7, 'Aesthetic parrah coyyy, kalo kalian ke sini ga afdol kalo ga poto poto hhii', 'Nopenul ajah');
